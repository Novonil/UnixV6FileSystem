/**
 * ---------------------------------------------------------------------------------------------------------------------------------
 * 				File Name: 			Original.c
 * 				Authors: 			  NOVONIL DAS (nxd180022) & PARTH PADALKAR (pxp180054)
 * 				NETIDS:  			  nxd180022 & pxp180054
 * 				Class:               	 OS 5348.001
 * 				Project:                Project 3
 * ---------------------------------------------------------------------------------------------------------------------------------
 * 
...
if(args == NULL){
	...
	defaultName= getfileName(filePath);
